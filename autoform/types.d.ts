...
export declare const BUILT_IN_FIELD_TYPES: readonly ["text", "number", "checkbox", "select", "date", "datetime-local", "time", "array", "object"];
...
export type FieldSchema<TCustom extends string = never> = BaseFieldSchema<TCustom> | SelectFieldSchema<TCustom> | HasFields<TCustom>;
